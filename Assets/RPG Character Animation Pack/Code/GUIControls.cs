...
public class GUIControls : MonoBehaviour{
	...
	void OnGUI(){
		...
		if(!rpgCharacterController.isDead){
			if(rpgCharacterController.weapon == WeaponType.RELAX || rpgCharacterController.weapon != WeaponType.UNARMED){
				if(GUI.Button(new Rect(1115, 310, 100, 30), "Unarmed")){
					...
					rpgCharacterController.weapon = WeaponType.UNARMED;
					rpgCharacterController.canAction = true;
					rpgCharacterController.animator.SetTrigger("RelaxTrigger");
				}
				if(!rpgCharacterController.isSitting && !rpgCharacterController.isMoving && rpgCharacterController.weapon == WeaponType.RELAX){
			...
			if(rpgCharacterController.canAction && !rpgCharacterController.isRelax){
				if(rpgCharacterController.isGrounded){
					...
					if(rpgCharacterController.weapon != WeaponType.TWOHANDCROSSBOW && rpgCharacterController.weapon != WeaponType.RIFLE){
					...
					if(blockGui){
						...
						//ATTACK LEFT
						if(rpgCharacterController.weapon == WeaponType.SHIELD || rpgCharacterController.weapon == WeaponType.RIFLE || rpgCharacterController.weapon != WeaponType.ARMED || (rpgCharacterController.weapon == WeaponType.ARMED && rpgCharacterController.leftWeapon != 0) && rpgCharacterController.leftWeapon != 7){
							if(GUI.Button(new Rect(25, 85, 100, 30), "Attack L")){
								rpgCharacterController.Attack(1);
							}
						}
						//ATTACK RIGHT
						if(rpgCharacterController.weapon == WeaponType.RIFLE || rpgCharacterController.weapon != WeaponType.ARMED || (rpgCharacterController.weapon == WeaponType.ARMED && rpgCharacterController.rightWeapon != 0) || rpgCharacterController.weapon == WeaponType.ARMEDSHIELD){
							if(rpgCharacterController.weapon != WeaponType.SHIELD){
						...
						if(!rpgCharacterController.isMoving){
							if(rpgCharacterController.weapon == WeaponType.UNARMED){
				...
				if(!blockGui && !rpgCharacterController.isBlocking && rpgCharacterController.isGrounded){
					...
					if(rpgCharacterController.weapon != WeaponType.ARMED){
					...
					else if(rpgCharacterController.weapon == WeaponType.ARMED){
				...
				if((rpgCharacterController.weapon == WeaponType.ARMED || rpgCharacterController.weapon == WeaponType.STAFF || rpgCharacterController.weapon == WeaponType.UNARMED) && !blockGui){
